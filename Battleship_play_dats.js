...
//
  ...
  tmp168 = ats2jspre_eq_int1_int1(arg0, 10);
  if(tmp168) {
    ats2jspre_alert("You won!");
  } else {
    tmp169 = ats2jspre_eq_int1_int1(arg1, 10);
    if(tmp169) {
...
//
  ...
  tmp177 = ats2jspre_eq_int1_int1(arg0, 1);
  if(tmp177) {
    tmp176 = ats2jspre_eq_int1_int1(arg1, 1);
  } else {
    tmp176 = false;
  } // endif
  if(tmp176) {
    ...
    tmp184 = ats2jspre_eq_int1_int1(arg0, 1);
    if(tmp184) {
      ats2jspre_print_string("You hit at ");
      Battleship__printCoord_30(arg2, arg3);
      ...
      tmp191 = ats2jspre_eq_int1_int1(arg1, 1);
      if(tmp191) {
...
//
  while(true) {
    ...
    tmp205 = arg0[1];
    tmp206 = arg0[2];
    tmp209 = ats2jspre_gte_int0_int0(arg1, 0);
    if(tmp209) {
      tmp208 = ats2jspre_lt_int0_int0(arg1, 8);
    } else {
      tmp208 = false;
    } // endif
    if(tmp208) {
      tmp210 = ats2jspre_gte_int0_int0(arg2, 0);
      if(tmp210) {
        tmp207 = ats2jspre_lt_int0_int0(arg2, 8);
      } else {
        tmp207 = false;
      } // endif
    } else {
    ...
    if(tmp207) {
      tmp211 = ats2jspre_mtrxszref_get_at(tmp205, arg1, arg2);
      // ATScaseofseq_beg
      tmplab_js = 1;
      while(true) {
        tmplab = tmplab_js; tmplab_js = 0;
        switch(tmplab) {
          ...
          if(ATSCKptriscons(tmp211)) { tmplab_js = 4; break; }
          ...
          if(tmp206) {
            tmp215 = ats2jspre_JSmath_random();
            tmp214 = ats2jspre_mul_double_double(tmp215, 0.999999);
            tmp213 = ats2jspre_mul_double_int(tmp214, 8);
            tmp212 = ats2jspre_double2int(tmp213);
            tmp219 = ats2jspre_JSmath_random();
            tmp218 = ats2jspre_mul_double_double(tmp219, 0.999999);
            tmp217 = ats2jspre_mul_double_int(tmp218, 8);
            tmp216 = ats2jspre_double2int(tmp217);
            // ATStailcalseq_beg
            apy0 = arg0;
            apy1 = tmp212;
            apy2 = tmp216;
            ...
            tmp220 = ats2jspre_neg_int1(1);
            tmp221 = ats2jspre_neg_int1(1);
            tmpret204 = [tmp220, tmp221];
          } // endif
          break;
          // ATSbranchseq_end
        } // end-of-switch
      ...
      tmp222 = ats2jspre_neg_int1(2);
      tmp223 = ats2jspre_neg_int1(2);
      tmpret204 = [tmp222, tmp223];
    } // endif
...
//
  // ATSdynload()
  // ATSdynloadflag_sta(_057_Users_057_jgrishey_057_Workspace_057_cs520_055_2016_055_fall_055_jgrishey_057_Project_057_Battleship_play_056_dats__dynloadflag(385))
